...
static UIActivityIndicatorView *ind = nil;
...
- (void)paymentQueueRestoreCompletedTransactionsFinished:(SKPaymentQueue *)queue{
    ...
    [defualts setBool:YES forKey:@"restoreDone"];
...
- (void)restoreTransaction:(SKPaymentTransaction *)transaction {
    ...
    NSLog(@"Purchased but not visible id is %@",transaction.payment.productIdentifier);
